...
def find_covering_array(inital_state,k):
    ...
    while current_T >= final_T:
        ...
        if current_state_cost == 0:
            return True, best_state , iterations , False , False 
        
        if current_frozen_factor == 0:
            return False, best_state , iterations , True , False
    ...
    return False , best_state , iterations , False , True
...
def covering_array(k,executions):
    ...
    for i in range(executions):
        ...
        found , solution, iterations , frozen , finalTemp = find_covering_array(inital_state,k)
